          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                waitTime: "8-12 min",
                price: "$",
                extra: "Known for their peri-peri fries",
              },
            ].map((outlet, index) => (
              <Card key={index} className="bg-white shadow-md hover:shadow-xl transition-all">
                <CardHeader>
      ...
      <section className="bg-[#264653] py-16 text-white">
        <div className="container mx-auto px-4">
          ...
          <form className="max-w-md mx-auto">
            ...
            <Button
              type="submit"
              className="w-full bg-[#FF9F1C] hover:bg-[#E63946] transition-colors"
            >
              Submit Review
            </Button>
          </form>
            ...
            {[
              {
                ...
                description: "Get authentic feedback from fellow students",
              },
              {
                icon: Users,
                title: "Community Driven",
                description: "Join a vibrant food-loving university community",
              },
              {
                icon: ChevronRight,
                title: "Data Insights",
                description: "Access detailed analytics on campus food trends",
              },
            ].map((feature, index) => (
